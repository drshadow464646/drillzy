...
export default function SettingsPage() {
    ...
    const handleSignOut = async () => {
        ...
        await signOut();
        // The auth listener in UserDataProvider will handle the redirect.
    };
    ...
    const isNameChanged = name.trim() !== '' && name.trim() !== userData.name;
                ...
                <main className="mt-6 space-y-8">
                    ...
                    <div className="pt-4">
                        ...
                        <div className="mt-4 p-4 border-2 border-destructive/50 rounded-lg bg-destructive/5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <Button size="lg" variant="destructive" className="flex-shrink-0" onClick={handleSignOut} disabled={isSigningOut}>
                                {isSigningOut ? (
                                    <>
