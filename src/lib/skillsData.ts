...
export const allSkills: Skill[] = [
  ...
  { id: 'skill_009', category: 'creator', text: 'Create a playlist of music that inspires you.' },
  ...
  { id: 'skill_014', category: 'thinker', text: 'Plan your week ahead, setting clear goals.' },
